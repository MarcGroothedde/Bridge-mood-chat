...
npm install
```
2) Set your Claude key (keep it in `.env.local`)
```bash
...
- API route `app/api/chat/route.ts` runs detection, picks a mode, and streams Claude (`claude-3-5-sonnet-20241022`) token-by-token.
